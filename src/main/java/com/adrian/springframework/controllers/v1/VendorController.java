...
public class VendorController {
    ...
    public Mono<Vendor> createNewVendor(@RequestBody @ApiParam(value = "Required vendor object to create") Vendor vendor){
        return vendorService.createNewVendor(vendor);
    }

    @ApiOperation(value = "Update existing vendor")
    @PutMapping("{id}")
    public Mono<ResponseEntity<Vendor>> updateVendor(@PathVariable @ApiParam(value = "ID of vendor to update") String id, @RequestBody @ApiParam(value = "Required vendor object to update") Vendor vendor){
        return vendorService.updateVendor(id, vendor);
    }

    @ApiOperation(value = "Update vendor's data")
    @PatchMapping("{id}")
    public Mono<ResponseEntity<Vendor>> patchVendor(@PathVariable @ApiParam(value = "ID of vendor to update") String id, @RequestBody @ApiParam(value = "Required vendor object to update") Vendor vendor){
